...
{
    private List<Token> token_list;
    private List<Token> semantic_token_list;
    private Utils utils;
    public Compiler(Utils _utils)
    {
        this.token_list = new List<Token>();
        this.semantic_token_list = new List<Token>();
        this.utils = _utils;
    }
    public int RunCompilation()
    {
        ...
        {
            Console.WriteLine("Iniciando analise sintática");
            this.semantic_token_list = syntatic_instance.RunSyntaticAnalizer(this.token_list);

            Console.WriteLine(semantic_instance.Execution(semantic_token_list));
        }
